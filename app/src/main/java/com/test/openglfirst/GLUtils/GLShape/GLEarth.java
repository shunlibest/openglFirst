 ...
 * 表示地球的类，采用多重纹理
 */
public class GLEarth extends BaseSurfaceViewRender {
    ...
    protected String loadVertexShader() {
        return "shaders/earth.vert";
    }

    @Override
    protected String loadFragmentShader() {
        return "shaders/earth.frag";
    }
...
//        }.start();
    ...
    protected void initValues() {
        ...
        //获取白天、黑夜两个纹理引用
        uDayTexHandle= getUniform( "sTextureDay");
        uNightTexHandle= getUniform( "sTextureNight");
        //获取位置、旋转变换矩阵引用id
    ...
    protected void onDrawFrame() {
        ...
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, textureIdEarth);
